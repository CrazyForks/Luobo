                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildPrivacyPoint(
                      ...
                      title: l10n.noDataSelling,
                      description: l10n.noDataSellingDesc,
                    ),
                    const SizedBox(height: 16),
                    _buildPrivacyPoint(
                      icon: CupertinoIcons.device_phone_portrait,
                      color: const Color(0xFF3B82F6),
                      title: l10n.localFirstStorage,
                      description: l10n.localFirstStorageDesc,
                    ),
                    const SizedBox(height: 16),
                    _buildPrivacyPoint(
                      ...
                      description: l10n.anonymousAnalyticsDesc,
                    ),
