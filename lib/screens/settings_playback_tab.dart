...
class _SettingsPlaybackTabState extends State<SettingsPlaybackTab> {
  ...
  Future<void> _loadSettings() async {
    ...
    setState(() {
      ...
      _knowledgeLastUpdate = lastUpdate != null ? DateTime.tryParse(lastUpdate) : null;
  ...
  Widget _buildAiSection() {
    ...
    return _buildSection(
      title: AppLocalizations.of(context)!.aiSmartPlaylist,
      children: [
        // API Key
        ListTile(
          contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
        ...
        ListTile(
          ...
          leading: Container(
            ...
            child: const Icon(CupertinoIcons.globe, color: Colors.white, size: 18),
          ),
        ...
        ListTile(
          ...
          leading: Container(
            ...
            child: const Icon(CupertinoIcons.book, color: Colors.white, size: 18),
          ),
